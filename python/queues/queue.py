...
# class Queue:
#     def __init__(self):
#         self.items = {}        # similar to JS object
#         self.front_index = 0   # front of the queue
#         self.rear_index = 0    # next insert position
...
#     def __str__(self):
#         return str([
#             self.items[i] for i in range(self.front_index, self.rear_index)
#             if i in self.items
#         ])
